...
from module import memory as memory, memory_transfer as memory_2
from module.run import train_transfer as train
from module.learner import maddpg_sfs as RL_model
...
def parse_args():
    ...
    parser.add_argument("--istransfer", type=int, default=0, help="train or not")
    ...
    parser.add_argument("--checkpoint-dir", type=str, default="Phase_task_new/checkpoint/")
    parser.add_argument("--log-dir", type=str, default="./Phase_task_new/log")
...
def run(arglist):
    ...
    # replay_buffers_2 = memory_2.Memory(limit=arglist.buffer_size,

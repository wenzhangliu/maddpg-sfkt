...
class Memory(object):
    def __init__(self, limit, observation_shape, action_shape, reward_shape,
                 state_shape=None, feature_shape=None, policy_embedding_shape=None,
        ...
        self.features = RingBuffer(limit, shape=feature_shape)
        self.policy_embeddings = RingBuffer(limit, shape=policy_embedding_shape)
    ...
    def sample(self, batch_size):
        ...
        feature_batch = self.features.get_batch(batch_idxs)
        p_embedding_batch = self.policy_embeddings.get_batch(batch_idxs)
        ...
        result = {
            ...
            'features': array_min2d(feature_batch),
            'p_embedding': array_min2d(p_embedding_batch)
        }
    ...
    def append(self, obs0, action, reward, feature, p_embedding, obs1, terminal1,
        ...
        self.policy_embeddings.append(p_embedding)
